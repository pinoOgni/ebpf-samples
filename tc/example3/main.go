...
The ebpf code is this example3 is the same as example1.
...
Now we can stop the program and the clasct will be removed automatically.

We need to delete the tesbted:
